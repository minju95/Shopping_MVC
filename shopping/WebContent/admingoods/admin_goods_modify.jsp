...
<%
	...
	//AdminGoodsModifyForm 클래스에서 세팅한 request객체의 값인 agb를 받아옴 -> GoodsBean의클래스의 객체에 저장
%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>쇼핑몰 - 등록된 상품 정보 수정</title>
</head>
<body>
...
<tr>
	...
	<form name="goodsform" method="post" action="./GoodsModifyAction.ag">
	...
	<tr>
		...
		<tr>
			...
			<td><textarea name="goods_content" cols="50" rows="50"><%=agb.getGOODS_CONTENT() %></textarea></td>
		</tr>
		</table>
		</td>
	</tr>
