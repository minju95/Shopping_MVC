...
function check(){
	...
	//getElementById: id로 단일값 출력 시 사용
	//cf. getElementsByName : name으로 배열값(다중값) 출력 시 사용
...
function gNumCheck(){
	if(event.keyCode >=48 && event.keyCode <=57) { 
		//event.keyCode : ASCII 코드에 기반한 숫자로, 48~57은 숫자 0부터 9까지 해당
		return true;
	}else{
...
<body>
	...
	<tr>
		...
		<tr>
			<td colspan="2">
				<font size="2">&nbsp;&nbsp;&nbsp;(아이디와 비밀번호는 문자와 숫자를 조합하여 2~12자리로 만들어 주세요)</font>
			</td>
		</tr>
